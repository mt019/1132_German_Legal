# **Artikel 94 Absatz 1 Einleitungssatz**  
...
- **謂語（Prädikat）**：*ausgestattet sind*（被賦予）  
  - Zustandspassiv（靜態被動）
...
- **補語（Objektsatz / eingebetteter Satz）**  
...
<!-- - **Art. 93 Abs. 1 Nr. 3 GG a.F.**：與本款對應，原本列於第93條中 -->
...
本款針對「其餘公法上爭議」設定憲法法院的補充審判權，意在涵蓋未具特定憲法標準型的公權力爭議，形成「補充性權限條款」。
...
- **Art. 1–19 GG**：基本權章節，構成憲法訴願保護對象核心
- **Art. 20 Abs. 4 GG**：對抗違憲行為之抵抗權，屬憲政保障條款
<!-- - **Art. 93 Abs. 1 Nr. 4a GG a.F.**：原列於第93條，修法後歸入本條 -->
...
- **Art. 28 Abs. 2 GG**：明定「地方自治」為憲法保障的制度性保障原則（institutionelle Garantie）
<!-- - **Art. 93 Abs. 1 Nr. 4b GG a.F.**：本條原屬第93條，現併入94條 -->
...
- **Art. 61 GG**（總統彈劾）  
<!-- - **Art. 93 Abs. 1 Nr. 5 GG a.F.**：本條原為第93條第1項第5號，2024年修法後遷至此 -->
...
聯邦憲法法院亦得就下列情形裁定：由聯邦參議院、一邦政府或一邦人民代表機構提出申請，針對第72條第4項所涉情況，判斷依第72條第2項所要求的聯邦立法必要性是否已不復存在；或在第125a條第2項第1句所指情形下，聯邦法律是否已不再得以制定。法院對必要性已不存在或不得再制定聯邦法的認定，即視為依第72條第4項或第125a條第2項第2句所作的聯邦法律。依第1句提出的申請，僅在以下情況才允許：一是第72條第4項或第125a條第2項第2句所規定的法律草案已在聯邦議會中遭到否決，或在一年內未經審議並表決；二是該等草案已在聯邦參議院遭否決。
...
- **謂語（Prädikat）**  
  - *entscheidet auf Antrag ..., ob ... oder ...*  
    - 關鍵結構：ob 連接兩個判斷對象，為並列的雙重條件式疑問句

- **申請主體（auf Antrag ...）**  
  - *des Bundesrates, einer Landesregierung oder der Volksvertretung eines Landes*

- **受詞（Objektsatz）**  
  - 由 *ob* 引導的兩種可能情況構成判斷範圍：
    1. *ob ... die Erforderlichkeit ... nicht mehr besteht*（第72條第2項必要性是否已消失）
    2. *ob ... Bundesrecht ... nicht mehr erlassen werden könnte*（第125a條第2項情況下是否已無法再制定聯邦法）

- **語法特徵**  
  - *Konjunktiv II*：用於 *nicht mehr erlassen werden könnte* 表示假設與潛在立法障礙

#### **Satz 2（第二句）**

- **主語**：*Die Feststellung*
- **謂語**：*ersetzt ein Bundesgesetz ...*
- **受詞**：*ein Bundesgesetz nach Artikel 72 Absatz 4 oder nach Artikel 125a Absatz 2 Satz 2*
- **附屬句**：由 *dass ...* 引導之內容

#### **Satz 3（第三句）**

- **主語**：*Der Antrag nach Satz 1*
- **謂語**：*ist nur zulässig, wenn ... oder wenn ...*
- **從句**：*wenn ...* 條件從句 x 2，分別規範 Bundestag 與 Bundesrat 的立法行為失敗
...
| 動詞形式 | 原形 | 用法 | 搭配 | 詞義 |
|-----------|----------|--------|--------|--------|
| entscheidet | entscheiden | 現在時 | auf + Akk. | 裁定 |
| besteht (nicht mehr) | bestehen | 現在時 | — | 是否仍存在（存在性） |
| könnte erlassen werden | können + erlassen (Passiv, Konjunktiv II) | 假設語氣 | — | 是否可被制定 |
| ersetzt | ersetzen | 現在時 | Akk. | 替代、取代 |
| ist ... zulässig | sein + Adj. | 現在時 | — | 可接受、合法 |
| wurde ... abgelehnt | ablehnen (Passiv, Präteritum) | 被動語態 | — | 被否決 |
| wurde ... beraten / beschlossen | beraten, beschließen (Passiv) | 被動語態 | — | 被審議／被決議 |
...
| *ein Bundesgesetz* | **das Bundesgesetz** | 中性 | 單數 | 受格 | 聯邦法律 |
| *der Antrag* | **der Antrag** | 陽性 | 單數 | 主格 | 申請 |
| *die Gesetzesvorlage* | **die Gesetzesvorlage** | 陰性 | 單數 | 主格／受格 | 法律草案 |

#### **2.3 介詞短語解析**

- **auf Antrag von ...**：表示由誰提出申請
- **nach Artikel ...**：法律依據（參照條文）
- **soweit ... nicht ...**：條件副詞句，引導否定情況
...
此段確立聯邦憲法法院就「立法必要性消失」之判定權。特別是在《基本法》第72條與第125a條規範之聯邦與邦立法權劃分中，法院扮演一種「合憲性立法啟動前置判定機關」角色。

此規範目的在於：防止聯邦在「必要性已不存在」時仍繼續立法，以維持聯邦主義原則與邦權自主。

#### **3.2 德國基本法（GG）相關條文**

- **Art. 72 Abs. 2 GG**：規範聯邦在競爭性立法領域中介入之「必要性條件」
- **Art. 72 Abs. 4 GG**：規定聯邦法律於必要性消失後即失效
- **Art. 125a Abs. 2 GG**：承襲統一法制至憲法生效後之過渡條文，涉及可否再制定聯邦法之認定

#### **3.3 相關法學概念**

- **Bundesrechtsersetzende Feststellung（取代立法的裁定）**  
  指憲法法院的裁定效果等同於聯邦立法，其法律地位由條文明文授權

- **Zulässigkeit eines Antrags**  
  表申請程序上的合法性，不符特定條件即為不受理
...
聯邦憲法法院亦得在下列情況下作出裁決：由聯邦參議院、一邦政府或一邦人民代表機構提出申請，針對第72條第4項所涉之情形，判斷依據第72條第2項制定聯邦法律的必要性是否已不復存在；或是否在第125a條第2項第1句所指之情形下，聯邦法律已不再得以制定。
...
強調法院僅於立法路徑封閉或失效時方能介入，維持三權分立與程序補充原則。
...
<!-- - **Art. 93 GG a.F.** 亦有類似結尾授權句，原屬舊條文第93條收尾 -->
