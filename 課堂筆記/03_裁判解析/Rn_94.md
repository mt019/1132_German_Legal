# Rn. 94 程序加速與程序自主權：是否構成憲法上程序濫用？ {#rn-94}
...
被聲請人自己也承認，本案在時間流程上高度緊湊，且所討論的議題「並不單純」。
...
即便議會多數在程序設計上享有憲法保障的廣泛裁量空間，且在目前呈現之程序過程中，德國聯邦議院議事規則所規定的第二次審議期限（《議事規則》第81條第1款第2句）看似已獲遵守，仍須進一步審查，而該審查在暫時法律保護程序中無法完成，即：是否在本案中未有充分正當理由的情況下，實質侵害了聲請人之參與權，且由議會多數所選擇的程序設計是否構成對立法程序之濫用性加速（參見聯邦憲法法院2023年1月24日第二審判庭判決，案號 2 BvF 2/18，第96段）。
...
|------------------------------------|---------------------|----------------------------|-------------------------------|------------------------------------|----------------------------------------|
| zukommt                            | zukommen            | 可分動詞，現在式           | + Dativ                       | 歸屬於、落在……責任之中            | 常用於權限分配，例如：「某人享有⋯⋯權限」 |
| vorsieht                           | vorsehen            | 可分動詞，現在式           | + Akkusativ                   | 預見、規定（法律用語）            | 法律或規則中常見：條文「預定」某種程序    |
| gewahrt worden sein dürften        | wahren              | 被動 + 完成式 + 虛擬式 II | —                             | 應已被遵守                         | 表保留推測，不具確定性                   |
| bedarf                             | bedürfen            | 非反身動詞，現在式         | + Genitiv                     | 需要                               | 書面語常見，表示「……是必要的」           |
| beeinträchtigt wurden              | beeinträchtigen     | 被動語態，完成式           | + Akkusativ                   | 被損害、遭受侵害                   | 常用於權利受限語境                     |
| stellt sich … dar                  | sich darstellen     | 反身可分動詞               | als + Nominativ               | 呈現為、表現為                     | 可用於法律評價，如「構成⋯⋯」              |

**例句**

- *Dem Bundestag kommt die Gesetzgebungskompetenz zu.*（立法權歸於聯邦議會。）
- *Die Geschäftsordnung sieht eine Frist von zwei Tagen vor.*（議事規則規定了兩天的期限。）
- *Die Vorschriften wurden gewahrt.*（相關規定已被遵守。）
- *Die Maßnahme bedarf weiterer Prüfung.*（此措施仍需進一步審查。）
- *Das Recht wurde beeinträchtigt.*（權利受到侵害。）
- *Die Maßnahme stellt sich als rechtswidrig dar.*（該措施構成違法。）
