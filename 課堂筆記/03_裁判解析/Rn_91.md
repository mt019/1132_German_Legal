...
即使議會多數在決定議會程序流程上擁有廣泛的設計裁量權，仍有充分理由認為，程序自治並不免除其遵守《基本法》第38條第1款第2句所保障的議員平等地位之義務；若立法程序的設計在無正當理由下被完全或實質性忽視，即構成對議員權利的侵犯。
...
- *Auch wenn der Parlamentsmehrheit ein weiter Gestaltungsspielraum bei der Bestimmung der Verfahrensabläufe im Parlament zusteht*
  - **主語（Dativ）**：*der Parlamentsmehrheit*（陰性單數與格）→ **die Parlamentsmehrheit**
  - **謂語**：*zusteht*（原形：zustehen，可分動詞）→ 搭配與格
  - **補語**：*ein weiter Gestaltungsspielraum*（主格）
...
| ein weiter Gestaltungsspielraum | **der Gestaltungsspielraum** | 陽性 | 單數 | 主格 | 裁量空間 |
...
本句為本案判決的核心法律邏輯之一：即使多數黨有程序設計空間，也不得在無正當理由下忽視議員參與與平等原則。否則將構成對議員職能權利的違憲干預。
