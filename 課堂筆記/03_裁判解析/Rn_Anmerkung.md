...
2023年7月5日，聯邦憲法法院第二審判庭作出決定，命令德國聯邦議院不得如原計畫，在2023年7月3日至7日的會期內進行《建築能源法》草案的第二與第三次審議。
...
| *auf Erlass der einstweiligen Anordnung* | **die einstweilige Anordnung** | 陰性 | 單數 | 介詞結構補語（auf + Akk.） | 臨時處分之發布請求 |
...
- **內嵌 dass-從句內容（結果內容）**：
  ...
  - **主詞**：
    ...
    - 限定語依序擴展為：
      ...
      - *einer irreversiblen Verletzung ...*
      - *der Beteiligungsrechte des Bundestagsabgeordneten Thomas Heilmann (CDU)*
...
第二審判庭在其裁定中所提出的理由，在高度程度上延續了2023年1月24日關於上調政黨國家資助絕對上限的決定（見第88號以下段落），該決定中第二審判庭已深入處理了加速立法程序的問題。
...
- **受詞從句 dass ...**：
  ...
  - **主語（Subjekt）**：
    - *mit einem Eingreifen des BVerfG zu rechnen ist*
      - 不定詞構造作為主語，前置副詞結構：*in künftigen Streitfällen, in denen ...*
...
立法程序的具體設計原則上屬於議會立法者的職責，其擁有廣泛的裁量空間。
...
因此，第二審判庭在其裁定中指出，《議事規則》對《建築能源法》第二次審議所規定的期限「應已被遵守」（參見第94段）。
...
- **補語（Zweckangabe）**：
  - *auf Mitwirkung und Beratung*（關於參與與審議）
    - 與 *Rechnung tragen* 搭配，表所應尊重的議員職能面向
...
- **附屬狀語（Adverbiale）**：
  - *im Anschluss an die Entscheidung zum Parteienfinanzierungsgesetz*  
    - 固定片語 *im Anschluss an* + Akkusativ，表「接續於…」
...
在本案中，鑑於立法程序的異常密集性與其複雜性（見第94段），一旦本案主訴程序成功，將對議員參與權造成「不可逆的侵害」；正是這一點，對於聯邦憲法法院作出不利於議會自治的權衡結果（見第102段）起了決定性作用。
...
相對地，作為被聲請方的聯邦議院認為：倘若主案最終成功，聲請人即可因而獲得一種精神上的補償，這已屬足夠（參見第48、103段）。
...
第二審判庭經過審查後確認，即使《建築能源法》稍晚一些通過——即便是在暑假期間通過——也完全不會對該法預定於2024年1月1日生效造成任何影響（參見第100段）。
...
| sind zugegangen | zugehen | 收到、送達 | 是 | Perfekt | Dativ（allen Abgeordneten） |
...
| *die wesentlichen Textpassagen* | **die Textpassage** | 陰性 | 複數 | Akkusativ | 重要的文字段落 |
...
針對高度加速立法的問題，Oliver Lepsius 認為，這是源自「柏林的一種惡習」，而且早在「紅綠燈聯盟」（即現今聯合政府）成立前就已出現（引自《Beck aktuell》2023年7月7日）。
...
Lepsius 對聯邦憲法法院的決定給予正確評價，認為這是對抗部會及其幕僚持續削弱議會程序的一場「民主辯論文化的勝利」。
...
| *gegen eine fortschreitende Aushöhlung* | **die Aushöhlung** | 陰性 | 單數 | Akkusativ（介詞 *gegen*） | 削弱、侵蝕 |
...
| *bei einzelnen ... Coronamaßnahmen* | **die Maßnahme** | 陰性 | 複數 | Dativ（介詞 *bei*） | 措施（此處指新冠防疫措施） |
| *der ... Coronamaßnahmen* | **die Maßnahme** | 陰性 | 複數 | 屬格（Genitiv） | 某些措施的 |
| *im Krisenmodus* | **der Modus** | 陽性 | 單數 | Dativ（介詞 *in*） | 危機模式、緊急狀態下 |
...
聯邦憲法法院在此類案件中對議會自治界限的劃定，並不構成不被允許的權限逾越（參見 Julian Krüper，2023年7月12日 lto；相對意見見 Florian Meinel，2023年7月9日，Verfassungsblog 以及 Johannes Gallon，2023年7月10日，Verfassungsblog）。
...
這代表放棄對立法程序中期限所做的具體且僵化的規定（參見 Joachim Wieland，SPIEGEL+，2023年7月6日）。
