...
### **翻譯**
聯邦議會代表並「體現」人民，作為國家權力的最終承擔者（《基本法》第20條第2款與第38條第1款）。
...
<!--chapter:end:課堂筆記/Rn_349.md-->

---
title: "Rn. 350 - Budgetrecht und parlamentarische Planungsbeteiligung"
author: "王逸帆"
date: "2024-03-22"
version: "1.0"
...
# **Rn. 350：預算權與國家規劃參與（Budgetrecht und Planungseinfluss des Bundestages）**
...
此外，議會亦透過以下條文取得參與權限，包括：《基本法》第23條以下及第59條第2項（例如國際條約）、第87a條第1項第2句與第4項第2句（聯邦國防軍出動）、第91a與91b條（共同任務之規劃）、第104a條第4項（財政補助），另亦可參見《聯邦預算法》第10條。
...
### **翻譯**
聯邦議會在參與國家規劃方面的角色，目前已透過《基本法》針對下列數個領域，加上了諸多法律上的參與規定。
...
- *neben zahlreichen gesetzlichen Beteiligungen*（除了諸多法律上的參與外）→ 表讓步/附加
...
### **翻譯**
依據《基本法》第109條以下的規定，聯邦議會擁有預算權；此外，依據第109條第3項與第110條第2項，結合《穩定與成長促進法》第9條第2項、《預算原則法》第50至52條以及《聯邦預算法》的規定，中期財政規劃也賦予聯邦議會重要的參與與資訊權（參見 Rn. 541）。
...
| **StWG** | *Stabilitäts- und Wachstumsgesetz* | 《穩定與成長促進法》 | 旨在促進經濟穩定與成長，規定預算與中期規劃原則 |
...
### **翻譯**
此外，聯邦議會亦透過《基本法》第23條以下與第59條第2項（關於國際條約等）、第87a條第1項第2句與第4項第2句（聯邦國防軍出動）、第91a與91b條（共同任務之規劃）、第104a條第4項（財政補助）而取得參與權（另參見《聯邦預算法》第10條）。
...
| **Art. 87a I 2 GG** | 聯邦國防軍僅於防衛情況下出動（需國會決定） |
| **Art. 87a IV 2 GG** | 聯邦軍於內部部署作災害防救時，需依法律授權，國會具參與角色 |
...
### **翻譯**
此外，還應普遍指出議會的各種影響可能形式，包括：資訊獲取、諮詢、法律規定、質詢與單純的議會決議。
...
# „für das Volk und all seine Bürger“（為了人民及所有公民）
